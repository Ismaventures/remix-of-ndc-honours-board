...
const THEME_TOKENS: Record<ThemeMode, ThemeTokenMap> = {
  'outdoor-tactical-light': {
    ...
    muted: '221 20% 92%',
    'muted-foreground': '221 15% 35%',
    accent: '221 100% 25%',
    'accent-foreground': '0 0% 100%',
    border: '221 100% 25% / 0.15',
    input: '221 20% 90%',
    ring: '221 100% 25%',
    'sidebar-background': '0 0% 98%',
    'sidebar-foreground': '0 0% 0%',
    'sidebar-primary': '221 100% 25%',
    'sidebar-primary-foreground': '0 0% 100%',
    'sidebar-accent': '221 20% 90%',
    'sidebar-accent-foreground': '0 0% 0%',
    'sidebar-border': '221 100% 25% / 0.15',
    'sidebar-ring': '221 100% 25%',
    gold: '221 100% 25%',
    'gold-bright': '221 100% 35%',
    navy: '221 100% 25%',
    'navy-deep': '221 100% 15%',
    'military-green': '221 100% 25%',
  },
  'outdoor-high-contrast-command': {
    background: '0 0% 0%',
    foreground: '0 0% 100%',
